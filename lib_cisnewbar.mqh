...
class CisNewBar 
  {
   ...
   public:
      ...
      void              CisNewBar(ENUM_TIMEFRAMES time_period);
...
void CisNewBar::CisNewBar(ENUM_TIMEFRAMES time_period) {
   ...
   m_comment="";        // Comment of execution
   m_symbol=Symbol();   // Symbol name, by default - symbol of current chart
   m_period=time_period;   // Chart period, by default - period of current chart
